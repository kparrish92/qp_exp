...
- Systematic review of 92 L3 empirical studies: 59/92 typology, 29/92 L2 status<sup>1</sup> 
...
.large[
- As in previous studies, the acoustic continua are identical in each session. 
]

--

.large[
- The only difference is that the participants are informed that they are hearing sounds 
...
**H3:** Yes for the Spanish L1 group, but not for the English L1 group
]]
...
.large[
- A voicing and vowel continuum were used in the 2afc tasks
]

--

.large[
- A step of a respective continuum was added to the beginning of the second syllable of a pseudoword and two words were presented on screen. 
 - *pafri* and *bafri* were the given choices in the stops contimuum 
 - *ifri* and *ufri* were the given choices in the vowel continuum <sup>1</sup>
]
.footnote[
<sup>1</sup> Distinct language specific spelling was used in the pseudowords of the vowel continuum. 
]

--

.large[
 - the stop continuum used in previous studies was used here: it contained 17 steps and ranged in VOT from -35 to 50ms 
]

.large[
 - A vowel continuum was also created and used in order to evaluate the predictions of full transfer models
  - It contained 11 steps, ranged from /i/ to /u/, and varied only in F2
]
...
- T-tests of the crossovers suggested that L3 groups did not categorize the continua differently whether they were assigned to the Hungarian group or the French group, and regardless of their first language. 
]
...
- No difference was found when participants believed they would be hearing French vs. Hungarian 
