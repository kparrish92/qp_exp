...
<!-- You need to dedicate more of your discussion to comparing your study with previous DPBE studies. In the first paragraph you mention in a sentence or so that you replicate the effect from bilinguals. Good. Come back to this and expand. You need to say a good amount more here. --> 

<!-- You also need another section here about limitations and future research (the paragraph directly below fits in fine with that). Specifically, you need to address why you have some conflicting results. Why did the you find the DPE in some cases and not others? How does this compare with previous research? What should future researchers do differently? There is still a lot more to say here. --> 

<!-------------------------------------

# Phonetic interpretations/ consequences of the results -->

Amengual (2011) - word initial Spanish-English cognates beginning in /t/ were aspirated when non-cognates were not, suggesting that interlingual influence is lexically mediated. This finding was not replicated in perception when examining L2 and L3 connections, since the French and Hungarian groups did not categorize the continua differently. 
<!------------------------------------>


The evidence from the present study highlights the need to L3 phonology specific studies and models, and the need to carry out experiments in perception and production. The results reported here run contrary to those in production reported in the L3 phonology literature, such as [@hammarberg_articulatory_1993], in which the authors found a global influence of L2 in the beginning of L3 acquisition that eventually was replaced by L1 influence at a later testing time. 
...
The present study replicated the findings of previous studies that found evidence of conceptually-cued language mode effects in sound categorizations in late bilinguals `citations` and, in an extension to previous studies,  found evidence of a double phonemic boundary effect in vowels. 
