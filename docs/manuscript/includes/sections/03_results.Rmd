...
all_data %>% 
  ...
  ggtitle("Figure 4: Spanish L1 group pooled stops") 
...
The results of the vowels mirror those found in stops in the Spanish L1 group. First, there was evidence of a double phonemic boundary (`r pooled__vowel_sl1_se$statistic`). The L1 and the L3 were categorized similarly (`r pooled__vowel_sl1_sl3$statistic`), and the L2 and the L3 were categorized distinctly (`r pooled__vowel_sl1_el3$statistic`). Figure 5 is a graphical representation of the crossover boundaries of vowels in the pooled data of both Spanish L1 groups.
...
all_data %>% 
  ...
  geom_smooth(method = "glm", method.args = list(family = "binomial")) +
  facet_grid(. ~ l1) + ylab("Proportion /p/") + xlab("VOT") + 
  ggtitle("Figure 6: English L1 group pooled stops") 
